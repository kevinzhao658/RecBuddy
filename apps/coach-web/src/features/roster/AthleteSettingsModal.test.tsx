...
const plan = { id: 'p1', athlete_id: 'ath-1', goal_race: 'Riverside Half', goal_distance: '13.1 mi', goal_date: '2026-09-20', goal_time: '1:45:00' } as any
...
test('seeds the form from the plan and saves an edited goal', () => {
  ...
  expect(updateMutate).toHaveBeenCalledWith(
    { goalRace: 'City Marathon', goalDistance: '13.1 mi', goalDate: '2026-09-20', goalTime: '1:45:00' },
    expect.anything(),
  )
})
